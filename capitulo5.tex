...
\begin{enumerate}
    ...
    \item Se evidenció una correlación de Spearman de ($\rho_s = 0.9896$) entre el ranking PageRank y el ranking por in-degree. Esto confirma empíricamente la hipótesis principal: la centralidad transitiva aporta información crítica no capturada por métricas puramente locales. Se detectaron paquetes específicos (como \texttt{larsjsol/shellpic} o \texttt{explosion/spacy-stanfordnlp}) que constituyen puntos únicos de fallo invisibles en análisis tradicionales.
